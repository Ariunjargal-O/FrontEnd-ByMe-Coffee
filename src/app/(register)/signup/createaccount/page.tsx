            ...
            <div className="w-[510px] font-bold">
                ...
                <div className="mt-5">
                    ...
                    <div
                        ...
                        className={`w-[160px] h-[160px] rounded-full border-2 border-dashed mt-2 flex items-center justify-center overflow-hidden cursor-pointer ${submitted && !image ? "border-red-500" : "border-gray-300"
                            }`}
                    >
                        {previewUrl ? (
                            <img
                ...
                <div className="mt-5">
                    ...
                    <Input
                        ...
                        className={`h-[40px] mt-2 ${submitted && !name ? "border-red-500" : ""}`}
                        value={name}
                ...
                <div className="mt-3">
                    ...
                    <Input
                        ...
                        className={`h-[100px] mt-2 ${submitted && !about ? "border-red-500" : ""}`}
                        value={about}
                ...
                <div className="mt-3">
                    ...
                    <Input
                        placeholder="https://"
                        className={`h-[40px] mt-2 ${submitted && !isValidUrl(social) ? "border-red-500" : ""}`}
                        value={social}
