  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="w-[510px]">
        <div>
          <p className="text-[24px] font-bold">How would you like to be paid?</p>
          <p className="text-[16px] text-neutral-400">Enter location and payment details</p>
        </div>
          ...
          <div>
            ...
            <div className="mt-2">
              <Select onValueChange={setCountry}>
                <SelectTrigger className={`w-full ${errors.country ? errorStyle : ""}`}>
          ...
          <div className="mt-3 flex justify-between">
            <div>
              ...
              <Input
                ...
                className={`w-[250px] mt-2 ${errors.firstName ? errorStyle : ""}`}
              />
            ...
            <div>
              ...
              <Input
                ...
                className={`w-[250px] mt-2 ${errors.lastName ? errorStyle : ""}`}
              />
            ...
            <div>
              ...
              <div className="mt-2">
                <Select onValueChange={setMonth}>
                  <SelectTrigger className={`w-[165px] ${errors.month ? errorStyle : ""}`}>
                    <SelectValue placeholder="Select" />
                  </SelectTrigger>
                  <SelectContent>
                    {[
